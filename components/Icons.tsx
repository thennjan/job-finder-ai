...
export const BriefcaseIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.07a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25v-4.07a2.25 2.25 0 01.97-1.73L12 4.5l7.28 7.92a2.25 2.25 0 01.97 1.73z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21l-3.48-3.48m3.48 3.48V12m3.48 9.48L12 21m-3.48 3.48L12 16.5m0 0l3.48-3.48" />
    </svg>
);
